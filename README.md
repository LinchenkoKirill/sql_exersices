...
### 1 
Найдите номер модели, скорость и размер жесткого диска для всех ПК стоимостью менее 500 дол. Вывести: model, speed и hd. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=1)
...
### 2
Найдите производителей принтеров. Вывести: maker [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=2)
...
Найдите номер модели, объем памяти и размеры экранов ПК-блокнотов, цена которых превышает 1000 дол. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=3)
...
Найдите все записи таблицы Printer для цветных принтеров. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=4)
...
### 5 
Найдите номер модели, скорость и размер жесткого диска ПК, имеющих 12x или 24x CD и цену менее 600 дол. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=5)
...
### 6
Для каждого производителя, выпускающего ПК-блокноты c объёмом жесткого диска не менее 10 Гбайт, найти скорости таких ПК-блокнотов. Вывод: производитель, скорость. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=6)
...
### 7
Найдите номера моделей и цены всех имеющихся в продаже продуктов (любого типа) производителя B (латинская буква). [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=7)
...
### 8
Найдите производителя, выпускающего ПК, но не ПК-блокноты. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=8)
...
### 9
Найдите производителей ПК с процессором не менее 450 Мгц. Вывести: Maker [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=9)
...
### 10 
Найдите модели принтеров, имеющих самую высокую цену. Вывести: model, price [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=10)
...
### 11
Найдите среднюю скорость ПК. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=11)
...
### 12 
Найдите среднюю скорость ПК-блокнотов, цена которых превышает 1000 дол. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=12)
...
### 13
Найдите среднюю скорость ПК, выпущенных производителем A. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=13)
...
Найдите класс, имя и страну для кораблей из таблицы Ships, имеющих не менее 10 орудий. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=14)
...
Найдите размеры жестких дисков, совпадающих у двух и более PC. Вывести: HD [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=15)
...
Найдите пары моделей PC, имеющих одинаковые скорость и RAM. В результате каждая пара указывается только один раз, т.е. (i,j), но не (j,i), Порядок вывода: модель с большим номером, модель с меньшим номером, скорость и RAM. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=16)
...
Вывести: type, model, speed [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=17)
...
Найдите производителей самых дешевых цветных принтеров. Вывести: maker, price [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=18)
...
Вывести: maker, средний размер экрана. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=19)
...
Найдите производителей, выпускающих по меньшей мере три различных модели ПК. Вывести: Maker, число моделей ПК. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=20)
...
Вывести: maker, максимальная цена. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Для каждого значения скорости ПК, превышающего 600 МГц, определите среднюю цену ПК с такой же скоростью. Вывести: speed, средняя цена. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Вывести: Maker [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Перечислите номера моделей любых типов, имеющих самую высокую цену по всей имеющейся в базе данных продукции. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите производителей принтеров, которые производят ПК с наименьшим объемом RAM и с самым быстрым процессором среди всех ПК, имеющих наименьший объем RAM. Вывести: Maker [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите среднюю цену ПК и ПК-блокнотов, выпущенных производителем A (латинская буква). Вывести: одна общая средняя цена. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите средний размер диска ПК каждого из тех производителей, которые выпускают и принтеры. Вывести: maker, средний размер HD. [Ссылка](https://sql-ex.ru/learn_exercises.php)
...
Используя таблицу Product, определить количество производителей, выпускающих по одной модели. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=28)
...
В предположении, что приход и расход денег на каждом пункте приема фиксируется не чаще одного раза в день [т.е. первичный ключ (пункт, дата)], написать запрос с выходными данными (пункт, дата, приход, расход). Использовать таблицы Income_o и Outcome_o. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=29)
...
Вывод: point, date, суммарный расход пункта за день (out), суммарный приход пункта за день (inc). Отсутствующие значения считать неопределенными (NULL). [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=30)
...
Для классов кораблей, калибр орудий которых не менее 16 дюймов, укажите класс и страну. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Одной из характеристик корабля является половина куба калибра его главных орудий (mw). С точностью до 2 десятичных знаков определите среднее значение mw для кораблей каждой страны, у которой есть корабли в базе данных. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=32)
...
Укажите корабли, потопленные в сражениях в Северной Атлантике (North Atlantic). Вывод: ship. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Вывод: номер модели, тип модели. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=35)
...
Перечислите названия головных кораблей, имеющихся в базе данных (учесть корабли в Outcomes). [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите классы, в которые входит только один корабль из базы данных (учесть также корабли в Outcomes). [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите страны, имевшие когда-либо классы обычных боевых кораблей ('bb') и имевшие когда-либо классы крейсеров ('bc'). [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=38)
...
Найдите корабли, `сохранившиеся для будущих сражений`; т.е. выведенные из строя в одной битве (damaged), они участвовали в другой, произошедшей позже. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Вывести: maker, type [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=40)
...
иначе максимальную цену. [Ссылка](https://sql-ex.ru/learn_exercises.php)
...
Найдите названия кораблей, потопленных в сражениях, и название сражения, в котором они были потоплены. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Укажите сражения, которые произошли в годы, не совпадающие ни с одним из годов спуска кораблей на воду. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите названия всех кораблей в базе данных, начинающихся с буквы R. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=44)
...
Считать, что слова в названиях разделяются единичными пробелами, и нет концевых пробелов. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=45)
...
Для каждого корабля, участвовавшего в сражении при Гвадалканале (Guadalcanal), вывести название, водоизмещение и число орудий. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=46)
...
Определить страны, которые потеряли в сражениях все свои корабли. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=47)
...
Найдите классы кораблей, в которых хотя бы один корабль был потоплен в сражении. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите названия кораблей с орудиями калибра 16 дюймов (учесть корабли из таблицы Outcomes). [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Найдите сражения, в которых участвовали корабли класса Kongo из таблицы Ships. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=50)
...
Найдите названия кораблей, имеющих наибольшее число орудий среди всех имеющихся кораблей такого же водоизмещения (учесть корабли из таблицы Outcomes). [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=51)
...
имеющим число главных орудий не менее девяти, калибр орудий менее 19 дюймов и водоизмещение не более 65 тыс.тонн [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Определите среднее число орудий для классов линейных кораблей. Получить результат с точностью до 2-х десятичных знаков. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
С точностью до 2-х десятичных знаков определите среднее число орудий всех линейных кораблей (учесть корабли из таблицы Outcomes). [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=54)
...
Для каждого класса определите год, когда был спущен на воду первый корабль этого класса. Если год спуска на воду головного корабля неизвестен, определите минимальный год спуска на воду кораблей этого класса. Вывести: класс, год. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=55)
...
Для каждого класса определите число кораблей этого класса, потопленных в сражениях. Вывести: класс и число потопленных кораблей. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Для классов, имеющих потери в виде потопленных кораблей и не менее 3 кораблей в базе данных, вывести имя класса и число потопленных кораблей. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=57)
...
Вывод: maker, type, процентное отношение числа моделей данного типа к общему числу моделей производителя [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=58)
...
Посчитать остаток денежных средств на каждом пункте приема для базы данных с отчетностью не чаще одного раза в день. Вывод: пункт, остаток. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Замечание. Не учитывать пункты, информации о которых нет до указанной даты. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=60)
...
Посчитать остаток денежных средств на всех пунктах приема для базы данных с отчетностью не чаще одного раза в день. [Ссылка](https://sql-ex.ru/learn_exercises.php)
...
Посчитать остаток денежных средств на всех пунктах приема на начало дня 15/04/01 для базы данных с отчетностью не чаще одного раза в день. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Определить имена разных пассажиров, когда-либо летевших на одном и том же месте более одного раза. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=63)
...
Вывод: пункт, дата, тип операции (inc/out), денежная сумма за день. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=64)
...
остальные строки для ЭТОГО производителя должны содержать пустую строку символов (''). [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=65)
...
Вывод: дата, количество рейсов [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=66)
...
2) Использовать только таблицу Trip [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=67)
...
2) Использовать только таблицу Trip [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=68)
...
Вывод: пункт приема, день в формате "dd/mm/yyyy", остатки/задолженность на конец этого дня. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=69)
...
Укажите сражения, в которых участвовало по меньшей мере три корабля одной и той же страны. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=70)
...
Найти тех производителей ПК, все модели ПК которых имеются в таблице PC. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=71)
...
Вывести: имя пассажира и число полетов. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=72)
...
Вывод: страна, сражение [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=73)
...
Вывод: страна, класс [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=74)
...
Для отсутствующих продуктов/цен использовать NULL. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=75)
...
Определить время, проведенное в полетах, для пассажиров, летавших всегда на разных местах. Вывод: имя пассажира, время в минутах. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=76)
...
Ростова ('Rostov'). Вывод: число рейсов, дата. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=77)
...
Замечание: даты представить без времени в формате "yyyy-mm-dd". [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=78)
...
Вывод: имя пассажира, общее время в минутах, проведенное в полетах [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=79)
...
Найти производителей любой компьютерной техники, у которых нет моделей ПК, не представленных в таблице PC. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=80)
...
Из таблицы Outcome получить все записи за тот месяц (месяцы), с учетом года, в котором суммарное значение расхода (out) было максимальным. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=81)
...
Вывод: значение code, которое является первым в наборе из шести строк, среднее значение цены в наборе. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=82)
...
launched = 1915
class=Kongo
country=USA [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=83)
...
Вывод: название компании, количество пассажиров за каждую декаду [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=84)
...
При этом искомые производители PC должны выпускать не менее 3 моделей. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=85)
...
Вывод: maker, список типов продукции [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=86)
...
Вывод: имя пассажира, количество полетов в Москву [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=87)
...
Вывести: имя пассажира, число полетов и название компании. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=88)
...
Вывод: maker, число моделей [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Вывести все строки из таблицы Product, кроме трех строк с наименьшими номерами моделей и трех строк с наибольшими номерами моделей. [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
C точностью до двух десятичных знаков определить среднее количество краски на квадрате. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=91)
...
пустых к настоящему времени. Вывести имя квадрата [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Вывод: название компании, время в минутах. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=93)
...
Вывод: дата, количество рейсов [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=94)
...
Вывод: Название компании, 1), 2), 3), 4). [Ссылка](https://sql-ex.ru/learn_exercises.php#answer_ref)
...
Вывести название баллончика [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=96)
...
Вывод: code, speed, ram, price, screen. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=97)
...
Вывод: код модели, скорость процессора, объем памяти. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=98)
...
Вывод: пункт, дата прихода денег, дата инкассации. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=99)
...
В случае, если операций прихода/расхода за один день было не равное количество, выводить NULL в соответствующих колонках на месте недостающих операций. [Ссылка](https://sql-ex.ru/learn_exercises.php?LN=100)
